...
async def help(ctx: discord.Interaction):
    ...
    embed.add_field(name="/teaminfobyname <team_name>*", value="Get general information about a team", inline=False)
    ...
    embed.add_field(name="/worldrecord <season>", value="Get the world record for a certain season", inline=False)
    embed.add_field(name="/matchesplayed <season>", value="Get the amount of matches played in a season", inline=False)
    embed.add_field(name="/inspect", value="Runs Robot Inspection", inline=False)
    ...
    embed.add_field(name="/help", value="Shows this dialogue", inline=False)
